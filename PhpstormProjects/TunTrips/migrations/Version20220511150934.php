 ...
 */
final class Version20220511150934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE codevalidation (idcode INT AUTO_INCREMENT NOT NULL, code VARCHAR(10) NOT NULL, coderec_mp VARCHAR(15) DEFAULT NULL, email VARCHAR(15) NOT NULL, INDEX email (email), PRIMARY KEY(idcode)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evenement (idevent INT AUTO_INCREMENT NOT NULL, id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, lieu VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, capacite INT DEFAULT NULL, INDEX id (id), PRIMARY KEY(idevent)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE revtransport (id INT AUTO_INCREMENT NOT NULL, idUser INT NOT NULL, idTransport INT NOT NULL, depart VARCHAR(20) NOT NULL, destination VARCHAR(20) NOT NULL, distance DOUBLE PRECISION NOT NULL, prix DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transport (idtransport INT AUTO_INCREMENT NOT NULL, type VARCHAR(20) NOT NULL, capacite INT NOT NULL, immatricule VARCHAR(20) NOT NULL, dispo TINYINT(1) NOT NULL, lieuDispo VARCHAR(20) NOT NULL, idUser VARCHAR(20) NOT NULL, PRIMARY KEY(idtransport)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE revtransport');
